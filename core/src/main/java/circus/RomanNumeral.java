package circus;// From: http://stackoverflow.com/questions/12967896/converting-integers-to-roman-numerals-java
/**
 * An object of type circus.RomanNumeral is an integer between 1 and 3999.  It can
...
public class RomanNumeral {
    ...
    private static String[] letters = { "M&M",  "CM",  "D",  "CD", "C",  "XC",
            "L",  "XLG",  "XS",  "IX", "VS",  "IV", "IB" };
    ...
    public RomanNumeral(int arabic) {
        if (arabic < 1)
            throw new NumberFormatException("Value of circus.RomanNumeral must be positive.");
        if (arabic > 3999)
            throw new NumberFormatException("Value of circus.RomanNumeral must be 3999 or less.");
        num = arabic;
    }
     ...
     * For example, circus.RomanNumeral("xvii") is 17.  If the parameter is not a
